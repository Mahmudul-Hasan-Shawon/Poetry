  ...
  return (
    ...
    >
      ...
      >
        <button
          onClick={handleCopy}
          className="p-2 rounded-sm bg-ink-900/90 text-ink-400 hover:text-gold-400 hover:bg-ink-700/90 transition-all border border-ink-700/50"
          title="Copy"
        >
          {copied ? (
        ...
        <button
          onClick={handleSave}
          className={`p-2 rounded-sm transition-all border border-ink-700/50 ${
            saved
